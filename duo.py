...
def two_players():
    ...
    mode_button = Button(300, 250, solo_img, 1)
    music_button = Button(300, 400, solo_img, 1)
    ...
    def main_menu(cur_music):
        ...
        while running:
            ...
            draw_text('Custom', font3, BLACK, screen, 560, 415)
    ...
    def options():
        ...
        while running:
            ...
            if choose_bg_button.choose_background():
                cur_bg = background4
                return two_players(cur_music, cur_bg)
    ...
    def two_players(cur_music, cur_bg):
        FALL_BEGIN_SPEED = 6
        ACCELERATION = .1
        BOWL_LIVES = 100
        lives = BOWL_LIVES
