...
# Load background
casino_bg = pygame.image.load("./images/casino.jpg").convert()
...
def single_duo():
    running = True
    pygame.mixer.init()
    pygame.mixer.music.load('./sounds/LanCuoi.wav')
    pygame.mixer.music.play(-1)
    while running:
        # Custom
        screen.blit(casino_bg, (0, 0))
        # Mode button
        mode_img = pygame.image.load("./images/orange.png").convert()
        # Load button
        single_button = Button(150, 300, mode_img, 1)
        duo_button = Button(450, 300, mode_img, 1)
        draw_text('Mode', font4, YELLOW, screen, 355, 100)
        draw_text('Please choose mode! ', font3, YELLOW, screen, 290, 200)

        if single_button.choose():
            return single_player()
        draw_text('Single', font3, BLACK, screen, 220, 315)

        if duo_button.choose():
            pass
        draw_text('Duo', font3, BLACK, screen, 530, 315)
...
def single_player():
    ...
    play_img = pygame.image.load("./images/orange.png").convert()
    selection_img = pygame.image.load("./images/red.png").convert()
    ...
    # Load button
    back_button = ButtonSingle(0, 0, back_img, 0.4)
    back_selection_button = ButtonSingle(320, 545, selection_img, 0.8)
    play_button = ButtonSingle(100, 250, play_img, 1)
    music_back_button = ButtonSingle(0, 0, back_img, 0.4)
    choose_bg_button = ButtonSingle(100, 300, choose_bg_img, 0.2)
    choose_bg_button2 = ButtonSingle(300, 300, choose_bg_img2, 0.2)
    choose_bg_button3 = ButtonSingle(500, 300, choose_bg_img3, 0.2)
    ...
    def main_menu(cur_music):
        ...
        while running:
            ...
            # Exit Button
            if back_selection_button.back_selection():
                return single_duo()
